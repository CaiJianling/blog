 ...
 * @Date: 2026-08-06 18:51:38
 * @LastEditors: CaiJianling caijianling@outlook.com
 * @LastEditTime: 2026-08-10 00:58:21
 * @FilePath: /blog/resources/js/layouts/settings/layout.tsx
                        ...
                        {baseNavItems.map((item, index) => (
                            <Button
                                    ...
                                    className={cn('w-full justify-start font-medium', {
                                        'bg-accent text-accent-foreground shadow-sm': isCurrentOrParentUrl(item.href),
